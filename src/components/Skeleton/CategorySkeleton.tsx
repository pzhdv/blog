...
export const CategoryArticleCardSkeleton = () => {
  return (
    <div className="p-4 md:p-6 border-b border-gray-200 dark:border-gray-700 last:border-0 overflow-hidden">
      <div className="flex flex-col md:flex-row md:items-center gap-4">
        {/* ✅骨架图片容器加上 overflow‑hidden，和真实DOM保持一致 */}
        <SkeletonBase className="w-full md:w-64 aspect-video rounded-lg shrink-0 overflow-hidden" />
        <div className="flex-1">
          {/* 桌面端标签 */}
          <div className="hidden md:flex flex-wrap items-center gap-2 text-sm mb-2">
          ...
          {/* 移动端标签 */}
          <div className="md:hidden flex gap-1 text-sm mb-2">
            <SkeletonBase className="h-5 w-12 rounded-full" />
            <SkeletonBase className="h-5 w-14 rounded-full" />
          </div>

          {/* 标题 h3 text‑lg，骨架h‑6 保持不变 */}
          ...
          <div className="flex justify-between items-center w-full">
            <SkeletonBase className="md:hidden h-4 w-20" />
